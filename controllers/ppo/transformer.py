...
class Controller(BaseController):
    ...
    def __init__(self):
        ...
        checkpoint_path = "./models/ppo_transformer-small_20-rollouts/best_model_weights.pth"
    ...
    def update(self, target_lataccel_history, current_lataccel_history, state_history, action_history, future_plan):
        ...
        # Create tensor on the correct device directly
        input_tensor = torch.from_numpy(input_data.reshape(1, -1)).to(self.device)
