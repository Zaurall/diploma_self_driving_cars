...
from train.reinforcement_learning.ppo.policy import PPOPolicy
...
class PPOTrainer:
    ...
    def train(self, num_rollouts=1000):
        ...
        for rollout_idx in pbar:
            ...
            # Save checkpoint
            if rollout_idx % 10 == 0:
                torch.save(self.policy.state_dict(), f"model_weights_rollout_{rollout_idx}.pth")
                try:
...
def main():
    ...
    # Save final model
    torch.save(trainer.policy.state_dict(), "final_model_weights.pth")
