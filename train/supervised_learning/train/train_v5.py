...
class DrivingDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        input_aug = np.concatenate([input_features, future_plan_matrix], axis=1)      # (seq_len, 2 + FUTURE_K)
...
def main():
    ...
    input_size = 4 + FUTURE_K  # augmented with future plan vector
    hidden_size = 256
    num_layers = 2
